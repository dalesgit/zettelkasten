...
WHERE file.mtime >= date(today) - dur(3d) 
```
---
### Notes created today
```dataview
List FROM "" WHERE file.cday = date("2025-08-02") SORT file.ctime asc
```

### Notes last touched today
```dataview
List FROM "" WHERE file.mday = date("2025-08-02") SORT file.mtime asc
```
