---
created: 2025-07-06T07:30:19 (UTC -04:00)
tags: []
...
> ## Excerpt
> The Japanese interval walking training (IWT) method that improves blood pressure, strengthens muscles, and reduces belly fat quickly.
...
This “Japanese walking” exercise methodology, called interval walking training ([IWT](https://cdnsciencepub.com/doi/10.1139/apnm-2023-0595)), swaps steady strolling for bursts of brisk movement, then recovery‑paced steps.
...
Cardiometabolic researcher [Kristian Karstoft](https://researchprofiles.ku.dk/en/persons/kristian-karstoft) of the University of Copenhagen’s [Center for Healthy Aging](https://healthyaging.ku.dk/) has spent more than a decade tracking its effects.
...
Switching between fast and slow bouts nudges the body to use oxygen more efficiently, a trait measured by [VO2peak](https://pubmed.ncbi.nlm.nih.gov/17605959/).
...
Scientists call that improvement better [glycemic control](https://www.sciencedirect.com/topics/medicine-and-dentistry/glycemic-control), a term describing how tightly the body keeps glucose within a healthy range.
...
“Additionally, interval walking training is a great way to meet the recommended 150 minutes a week of moderate‑intensity aerobic activity,” noted [Sarah F. Eby](https://www.massgeneral.org/doctors/23054/sarah-eby), the sports medicine specialist at Mass [General Brigham](https://www.massgeneral.org/) and assistant professor at [Harvard Medical School](https://connects.catalyst.harvard.edu/Profiles/display/Person/211149).
...
A simple watch or phone app can cue the switches, though early Japanese volunteers used a waist‑worn beeper nicknamed [JD Mate](https://www.pubcompare.ai/product/VyniCZIBPBHhf-iFORRd/). Supportive shoes and a safe sidewalk are the only other requirements.

## Proof in older adults

In a seminal five‑month experiment involving [adults averaging sixty‑three years old](https://pubmed.ncbi.nlm.nih.gov/25539937/), IWT raised VO2peak ten percent and drove [systolic pressure](https://www.heart.org/en/health-topics/high-blood-pressure/understanding-blood-pressure-readings) down nine millimeters of mercury compared with either continuous walking or no exercise.
...
A Danish trial later pitted IWT against energy‑matched continuous [walking](https://www.earth.com/news/dog-walking-improves-mobility-and-prevents-falls-in-older-adults/) in adults living with type 2 diabetes.
...
Digital prompts can help sustain motivation once novelty fades. Yet data from a Danish smartphone roll‑out show that unsupervised users averaged only nine minutes of fast [walking](https://www.earth.com/news/upright-walking-may-have-sparked-human-creativity-and-music/) per week after a year, underscoring the value of social or clinical follow‑up.
...
“Studies specifically looking at the benefits of interval [walking training](https://www.earth.com/news/walking-can-counteract-the-health-risks-of-sitting/) have found improved physical fitness, muscle strength, and glycemic control,” said Eby.
...
The study is published in [_Applied Physiology, Nutrition, and Metabolism_](https://cdnsciencepub.com/doi/10.1139/apnm-2023-0595).
