---
created: 2025-11-12T10:20:19 (UTC -05:00)
tags: []
...
## [](https://rclone.org/drive/#configuration)Configuration
...
See the [remote setup docs](https://rclone.org/remote_setup/) for how to set it up on a machine without an internet-connected web browser available.
...
### [](https://rclone.org/drive/#scopes)Scopes
...
#### [](https://rclone.org/drive/#drive)drive
...
#### [](https://rclone.org/drive/#drive-appfolder)drive.appfolder
...
#### [](https://rclone.org/drive/#drive-metadata-readonly)drive.metadata.readonly
...
### [](https://rclone.org/drive/#root-folder-id)Root folder ID
...
### [](https://rclone.org/drive/#service-account-support)Service Account support
...
#### [](https://rclone.org/drive/#use-case-google-workspace-account-and-individual-drive)Use case - Google Workspace account and individual Drive

Let's say that you are the administrator of a Google Workspace. The goal is to read or write data on an individual's Drive account, who IS a member of the domain. We'll call the domain <example.com>, and the user [foo@example.com](mailto:foo@example.com).

There's a few steps we need to go through to accomplish this:

##### [](https://rclone.org/drive/#1-create-a-service-account-for-example-com)1\. Create a service account for example.com
...
##### [](https://rclone.org/drive/#2-allowing-api-access-to-example-com-google-drive)2\. Allowing API access to example.com Google Drive
...
##### [](https://rclone.org/drive/#3-configure-rclone-assuming-a-new-install)3\. Configure rclone, assuming a new install

```sh
rclone config n/s/q> n # New name>gdrive # Gdrive is an example name Storage> # Type drive client_id> # Can be left blank client_secret> # Can be left blank scope> # Select the scope use used in step 2 root_folder_id> # Can be left blank service_account_file> /home/foo/myJSONfile.json # Path to the JSON file you downloaded in step 1. y/n> # Auto config, n
```

##### [](https://rclone.org/drive/#4-verify-that-it-s-working)4\. Verify that it's working
...
### [](https://rclone.org/drive/#shared-drives-team-drives)Shared drives (team drives)
...
```text
Configure this as a Shared Drive (Team Drive)? y) Yes n) No y/n> y Fetching Shared Drive list... Choose a number from below, or type in your own value 1 / Rclone Test \ "xxxxxxxxxxxxxxxxxxxx" 2 / Rclone Test 2 \ "yyyyyyyyyyyyyyyyyyyy" 3 / Rclone Test 3 \ "zzzzzzzzzzzzzzzzzzzz" Enter a Shared Drive ID> 1 Configuration complete. Options: - type: drive - client_id: - client_secret: - token: {"AccessToken":"xxxx.x.xxxxx_xxxxxxxxxxx_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx","RefreshToken":"1/xxxxxxxxxxxxxxxx_xxxxxxxxxxxxxxxxxxxxxxxxxx","Expiry":"2014-03-16T13:57:58.955387075Z","Extra":null} - team_drive: xxxxxxxxxxxxxxxxxxxx Keep this "remote" remote? y) Yes this is OK e) Edit this remote d) Delete this remote y/e/d> y
```

### [](https://rclone.org/drive/#fast-list)\--fast-list
...
### [](https://rclone.org/drive/#modification-times-and-hashes)Modification times and hashes
...
### [](https://rclone.org/drive/#restricted-filename-characters)Restricted filename characters
...
### [](https://rclone.org/drive/#revisions)Revisions
...
### [](https://rclone.org/drive/#deleting-files)Deleting files
...
### [](https://rclone.org/drive/#shortcuts)Shortcuts
...
### [](https://rclone.org/drive/#emptying-trash)Emptying trash
...
### [](https://rclone.org/drive/#quota-information)Quota information
...
#### [](https://rclone.org/drive/#import-export-of-google-documents)Import/Export of google documents
...
### [](https://rclone.org/drive/#standard-options)Standard options

Here are the Standard options specific to drive (Google Drive).

#### [](https://rclone.org/drive/#drive-client-id)\--drive-client-id
...
#### [](https://rclone.org/drive/#drive-client-secret)\--drive-client-secret
...
#### [](https://rclone.org/drive/#drive-scope)\--drive-scope
...
#### [](https://rclone.org/drive/#drive-service-account-file)\--drive-service-account-file
...
-   Config: service\_account\_file
-   Env Var: RCLONE\_DRIVE\_SERVICE\_ACCOUNT\_FILE
-   Type: string
-   Required: false

#### [](https://rclone.org/drive/#drive-alternate-export)\--drive-alternate-export
...
### [](https://rclone.org/drive/#advanced-options)Advanced options

Here are the Advanced options specific to drive (Google Drive).

#### [](https://rclone.org/drive/#drive-token)\--drive-token
...
#### [](https://rclone.org/drive/#drive-auth-url)\--drive-auth-url
...
#### [](https://rclone.org/drive/#drive-token-url)\--drive-token-url
...
#### [](https://rclone.org/drive/#drive-client-credentials)\--drive-client-credentials
...
#### [](https://rclone.org/drive/#drive-root-folder-id)\--drive-root-folder-id
...
#### [](https://rclone.org/drive/#drive-service-account-credentials)\--drive-service-account-credentials
...
#### [](https://rclone.org/drive/#drive-team-drive)\--drive-team-drive
...
#### [](https://rclone.org/drive/#drive-auth-owner-only)\--drive-auth-owner-only
...
#### [](https://rclone.org/drive/#drive-use-trash)\--drive-use-trash
...
#### [](https://rclone.org/drive/#drive-copy-shortcut-content)\--drive-copy-shortcut-content
...
#### [](https://rclone.org/drive/#drive-skip-gdocs)\--drive-skip-gdocs
...
#### [](https://rclone.org/drive/#drive-show-all-gdocs)\--drive-show-all-gdocs
...
-   Config: show\_all\_gdocs
-   Env Var: RCLONE\_DRIVE\_SHOW\_ALL\_GDOCS
-   Type: bool
-   Default: false

#### [](https://rclone.org/drive/#drive-skip-checksum-gphotos)\--drive-skip-checksum-gphotos
...
#### [](https://rclone.org/drive/#drive-shared-with-me)\--drive-shared-with-me
...
#### [](https://rclone.org/drive/#drive-trashed-only)\--drive-trashed-only
...
#### [](https://rclone.org/drive/#drive-starred-only)\--drive-starred-only

Only show files that are starred.

Properties:

-   Config: starred\_only
-   Env Var: RCLONE\_DRIVE\_STARRED\_ONLY
-   Type: bool
-   Default: false

#### [](https://rclone.org/drive/#drive-formats)\--drive-formats
...
#### [](https://rclone.org/drive/#drive-export-formats)\--drive-export-formats
...
#### [](https://rclone.org/drive/#drive-import-formats)\--drive-import-formats
...
#### [](https://rclone.org/drive/#drive-allow-import-name-change)\--drive-allow-import-name-change
...
#### [](https://rclone.org/drive/#drive-use-created-date)\--drive-use-created-date
...
#### [](https://rclone.org/drive/#drive-use-shared-date)\--drive-use-shared-date
...
#### [](https://rclone.org/drive/#drive-list-chunk)\--drive-list-chunk
...
#### [](https://rclone.org/drive/#drive-impersonate)\--drive-impersonate
...
#### [](https://rclone.org/drive/#drive-upload-cutoff)\--drive-upload-cutoff
...
#### [](https://rclone.org/drive/#drive-chunk-size)\--drive-chunk-size
...
#### [](https://rclone.org/drive/#drive-acknowledge-abuse)\--drive-acknowledge-abuse
...
#### [](https://rclone.org/drive/#drive-keep-revision-forever)\--drive-keep-revision-forever
...
#### [](https://rclone.org/drive/#drive-size-as-quota)\--drive-size-as-quota
...
#### [](https://rclone.org/drive/#drive-v2-download-min-size)\--drive-v2-download-min-size
...
#### [](https://rclone.org/drive/#drive-pacer-min-sleep)\--drive-pacer-min-sleep
...
#### [](https://rclone.org/drive/#drive-pacer-burst)\--drive-pacer-burst
...
#### [](https://rclone.org/drive/#drive-server-side-across-configs)\--drive-server-side-across-configs
...
#### [](https://rclone.org/drive/#drive-disable-http2)\--drive-disable-http2
...
#### [](https://rclone.org/drive/#drive-stop-on-upload-limit)\--drive-stop-on-upload-limit
...
#### [](https://rclone.org/drive/#drive-stop-on-download-limit)\--drive-stop-on-download-limit
...
#### [](https://rclone.org/drive/#drive-skip-shortcuts)\--drive-skip-shortcuts
...
#### [](https://rclone.org/drive/#drive-skip-dangling-shortcuts)\--drive-skip-dangling-shortcuts
...
#### [](https://rclone.org/drive/#drive-resource-key)\--drive-resource-key
...
#### [](https://rclone.org/drive/#drive-fast-list-bug-fix)\--drive-fast-list-bug-fix
...
#### [](https://rclone.org/drive/#drive-metadata-owner)\--drive-metadata-owner
...
#### [](https://rclone.org/drive/#drive-metadata-permissions)\--drive-metadata-permissions
...
#### [](https://rclone.org/drive/#drive-metadata-labels)\--drive-metadata-labels
...
#### [](https://rclone.org/drive/#drive-encoding)\--drive-encoding
...
#### [](https://rclone.org/drive/#drive-env-auth)\--drive-env-auth
...
#### [](https://rclone.org/drive/#drive-description)\--drive-description
...
### [](https://rclone.org/drive/#metadata)Metadata
...
## [](https://rclone.org/drive/#backend-commands)Backend commands
...
### [](https://rclone.org/drive/#get)get
...
### [](https://rclone.org/drive/#set)set
...
### [](https://rclone.org/drive/#shortcut)shortcut
...
In the first example this creates a shortcut from the "source\_item" which can be a file or a directory to the "destination\_shortcut". The "source\_item" and the "destination\_shortcut" should be relative paths from "drive:"
...
### [](https://rclone.org/drive/#drives)drives
...
### [](https://rclone.org/drive/#untrash)untrash
...
### [](https://rclone.org/drive/#copyid)copyid
...
### [](https://rclone.org/drive/#moveid)moveid
...
### [](https://rclone.org/drive/#exportformats)exportformats
...
### [](https://rclone.org/drive/#importformats)importformats
...
### [](https://rclone.org/drive/#query)query
...
### [](https://rclone.org/drive/#rescue)rescue
...
## [](https://rclone.org/drive/#limitations)Limitations
...
### [](https://rclone.org/drive/#limitations-of-google-docs)Limitations of Google Docs
...
### [](https://rclone.org/drive/#duplicated-files)Duplicated files
...
### [](https://rclone.org/drive/#rclone-appears-to-be-re-copying-files-it-shouldn-t)Rclone appears to be re-copying files it shouldn't
...
### [](https://rclone.org/drive/#sha1-or-sha256-hashes-may-be-missing)SHA1 or SHA256 hashes may be missing
...
## [](https://rclone.org/drive/#making-your-own-client-id)Making your own client\_id
...
5.  If you already configured an "Oauth Consent Screen", then skip to the next step; if not, click on "CONFIGURE CONSENT SCREEN" button (near the top right corner of the right panel), then click "Get started". On the next screen, enter an "Application name" ("rclone" is OK); enter "User Support Email" (your own email is OK); Next, under Audience select "External". Next enter your own contact information, agree to terms and click "Create". You should now see rclone (or your project name) in a box in the top left of the screen.
    ...
    You will also have to add [some scopes](https://developers.google.com/drive/api/guides/api-specific-auth), including
...
6.  After adding scopes, click Audience Scroll down and click "+ Add users". Add yourself as a test user and press save.
...
9.  Go to "Audience" and then click "PUBLISH APP" button and confirm. Add yourself as a test user if you haven't already.
