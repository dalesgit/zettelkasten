...
Readwise is pretty solid for what it does. It keeps your reading highlights in one place and helps you surface them instantly. It just makes it easy to [remember what you read](https://www.xda-developers.com/forget-goodreads-use-self-hosted-book-tracker/) and keep track of important snippets, whether for research or personal purposes. And it has superior integration, letting you sync it with nearly every app under the sun - Kindle, Apple Books, Pocket, Medium, NotebookLM, you name it. The problem is that Readwise is a paid service, so it starts becoming one of those subscriptions you only pay because you’re used to having it in your [reading kit](https://www.xda-developers.com/open-source-tools-for-students-to-save-money-and-time/), not because it’s necessarily making your reading life better.
...
I wanted to see if there were free alternatives, and that’s how I came across PastReads. It’s a similar concept in that it syncs with your reading apps or web pages and pulls highlights from them - just with a different interface. I started to slowly replace some of Readwise’s functionality with PastReads, and I kind of regret ever paying for Readwise now…
 ...
 ![ChatGPT study mode on desktop pc, lego and lamp in view](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/11/chatgpt-study-mode-on-desktop-pc-lego-and-lamp-in-view.jpeg?q=49&fit=crop&w=220&h=182&dpr=2)
...
### A free Readwise alternative
   ...
   ![PastReads home dashboard](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/11/pastreads-home-dashboard.png?q=49&fit=crop&w=825&dpr=2)

PastReads is a home base and manager for everything you highlight while reading. It pulls your highlights from apps like Kindle, Apple Books, Kobo, and, funnily Readwise, as well as from the open web. There’s also the [PastReads Web Highlighter extension](https://chromewebstore.google.com/detail/pastreads-web-highlighter/jabdeombiekcdlfchpafmnjlaheejiho) I recommend installing for pulling highlights directly from any web page. PastRead’s design is super simple, grounded, and functional, yet it’s still as feature-rich as Readwise. You get a clean library, solid organization tools, and a couple of extras that actually make it a better experience than Readwise.
...
The basic use of PastReads is free, offering unlimited highlights and notes, highlighting from any web page, organizing features, global search, and book app integration. There is a paid tier, however, which gives you access to a recap feature, unlimited tags, and export to Notion. Whether you go with the free or pro plan ($5 per month), both give you greater value than Readwise’s $12 monthly plan (and no free option).
 ...
 ![NotebookLM OOP notebook displayed on an iPad next to a Stanley](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/05/notebooklm-oop-notebook-displayed-on-an-ipad-next-to-a-pink-stanley-5.jpg?q=49&fit=crop&w=220&h=182&dpr=2)

Related

## How PastReads stacks up against Readwise
...
One thing that PastReads has that Readwise doesn’t is an instant click-through for any web links you added. Even if you only highlight a couple of words from a page, it will let you visit that page. Recaps isn’t a feature I’ve tried as it’s part of the paid plan, but basically, it sends you updates so you can continuously check in and update your highlights.
 ...
 ![A Windows 11 laptop running ClipClip and Notepad](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2024/12/clipclip-on-windows.jpg?q=49&fit=crop&w=220&h=182&dpr=2)

Related

## Where PastReads misses the mark

### It’s great, but still not as robust as Readwise in some areas

   ![PastReads integration options](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/11/pastreads-integration-options.png?q=49&fit=crop&w=825&dpr=2)

The biggest downside to switching from Readwise to PastReads is the lack of integration options. Readwise has integrations for a whopping 30+ tools, whereas PastReads only has a handful. This also means that if I wanted to [integrate it with NotebookLM](https://www.xda-developers.com/pairing-notebooklm-with-readwise/), I would have to copy everything over manually. Another win for Readwise is its Reader app. This is a dedicated reading app that lets you actually store and interact with your reading materials beyond just the highlights, at no additional cost to your Readwise subscription. And it [pairs really well with NotebookLM](https://www.xda-developers.com/apps-go-from-basic-to-brilliant-pairing-with-notebooklm/), too.

 ![NotebookLM learning guide mode](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/notebooklm-learning-guide-mode.jpeg?q=49&fit=crop&w=220&h=182&dpr=2)

Related

### The case for switching to PastReas
...
Minus the Reader app or NotebookLM integration, I’m pretty much getting the exact same experience from PastReads as I did from Readwise, all for free. If you’re someone who highlights everything, or constantly bookmarks it or copies the text, only to never look at it again, PastReads is such an easy way to actually put that content to use.
   ...
   ![PastReads logo](https://static0.xdaimages.com/wordpress/wp-content/uploads/2025/11/pastreads-logo.png?q=70&fit=contain&w=420&dpr=1)
