...
## Notes
- [[I should have started using this open-source graphics tool before paying for Adobe]]
...
- [[flexible-liturgy]] 
- Nicholas Ferrar and John of Damascus at church
- Dorothy? Lunch from centering prayer. 
- 
```dataview
table without id
	mood + " #_/habits" AS "🌄",
...
### Todo's
- [ ] Join with Sean and Amy to give MP *story word* . They can select questions to send that they would be interested in. 
```dataview
task
...
1. Learning:: The abc app provides lots of useability. Very cool. PDF, MP3, editing, playing midi-file.
