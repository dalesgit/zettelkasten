...
aliases:
  - Scott call
location: Home
mood: wanting to be alone
tag:
  - Daily
sleep: 6 plus with an interruption
weight:
prayer:
meditation:
exercise:
...
1. Good:: I gave an arm to the lady at the altar rail. I took communion to a lady who hadn't been in church in 30 years.

## What excited or drained me?
1. Exciting:: Speaking about Emma jumping into my arms as an example of "faith"
2. Draining:: 

## Reading, thought
1. kindle:: Gengi -- first novel?
2. podcast::
```dataviewjs
