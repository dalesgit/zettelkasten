...
aliases:
  - Priest on staff
tags: []
mood: Wanting to avoid
sleep: 7 hours
stretch: Another party
tag:
  - Daily
week: 2025-W48
weekday: Saturday
...
## Notes
- [[poem-11-29]]
- [[mx-linux keyboard on Chromebook]]
- #resistance I just realized why words from our Presiding Bp. are so empty to me versus those from Pope Leo -- or even the Catholic Bishops. The [[authority]] of Presiding Bp is very limited while that of Diocesans I have experienced as akin to a local despot.
- I registered with "PastReads" as a replacement for "Readwise". Import notes from Kindle? #security dch2Pastreads! #reading 
	- 2025-12-14 changed password to dch2PastReads!
	- upload My Clippings.txt
	- or email to "add@pastreads.com"
- [[Thanksgiving email]]
- Linking this with Obsidian? I love it. through plugin: "edit with neovim"
...
1. Learning:: "Pastreads" as a replacement for "Readwise" -- import Kindle notes?
