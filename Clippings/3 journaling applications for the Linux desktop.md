---
title: "3 journaling applications for the Linux desktop"
source: "https://opensource.com/article/18/6/linux-journaling-applications"
author:
  - "[[Scott Nesbitt]]"
published:
created: 2026-01-07
...
No matter what your reasons are for keeping a journal or a diary, there are a variety of ways in which to do that. You could go old school and use pen and paper. You could use a web-based application. Or you could turn to the [humble text file](https://plaintextproject.online/2017/07/19/journal.html).
...
![RedNotebook](https://opensource.com/sites/default/files/uploads/red-notebook.png "RedNotebook")

Of the three journaling applications described here, [RedNotebook](https://rednotebook.sourceforge.net/) is the most flexible. Much of that flexibility comes from its templates. Those templates let you record personal thoughts or meeting minutes, plan a journey, or log a phone call. You can also edit existing templates or create your own.
...
![Lifeograph](https://opensource.com/sites/default/files/uploads/lifeograph.png "Lifeograph")

[Lifeograph](https://lifeograph.sourceforge.net/wiki/Main_Page) has a similar look and feel to RedNotebook. It doesn't have as many features, but Lifeograph gets the job done.
...
![Almanah](https://opensource.com/sites/default/files/uploads/almanah.png "Almanah")

[Almanah Diary](https://wiki.gnome.org/Apps/Almanah_Diary) is another very simple journaling tool. But don't let its lack of features put you off. It's simple, but it gets the job done.
...
One that I've tried and liked is [jrnl](https://maebert.github.com/jrnl/). Or you can use [this solution](https://tamilinux.wordpress.com/2007/07/27/writing-short-notes-and-diaries-from-the-cli/), which uses a command line alias to format and save your journal entries into a text file.
